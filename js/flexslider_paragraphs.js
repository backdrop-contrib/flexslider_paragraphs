...
(function ($) {
  Backdrop.behaviors.flexslider_paragraphs = {
    attach: function (context, settings) {
      var ids = Backdrop.settings.flexslider_paragraphs.ids;
      var autoscroll = Backdrop.settings.flexslider_paragraphs.autoscroll;
